...
struct AtlasMark: View {
  /// The full heart-on-ring composition reads well at splash size (120pt), but the
  /// ring crowds out the heart at icon sizes (e.g. the 28pt mark next to the Library
  /// wordmark) — so small placements drop the ring and show just the heart, mirroring
  /// how the App Icon itself is a cropped detail rather than the full mark.
  var includesRing = true
